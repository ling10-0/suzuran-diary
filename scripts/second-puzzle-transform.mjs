...
Object.assign(mainlineCases[1], {
  ...
  type: 'investigation',
  code: '商工第〇二號',
  taskTitle: '敷島町市場＋榮記餅店',
  directoryTitle: '敷島町市場＋榮記餅店',
  label: '敷島町市場＋榮記餅店',
  inputLabel: '請選擇解讀出的姓氏',
  hint: '先查看兩份原始資料，依貨物交易紀錄中的訂單編號、品項與數量，對照暗碼表解讀文字。',
  question: '解讀出的文字，對應到下列哪一個姓氏？',
  questionDetails: [
    '近期店家在整理倉庫時，找到一本年代久遠的訂貨簿，簿冊中有幾頁的字跡和其他頁面不同，紙張角落還留有藍綠色的小圈記號。',
    '根據店家長輩過去留下的說法，從前曾有一名外地男子在市場附近幫忙。他不太會說臺語，卻很會計算，也會替店家整理帳目、繪製簡單的配置圖。居民一直不知道他的完整姓名，只記得他不是本地人，而且店員似乎刻意沒有把名字寫進一般帳冊。',
    '後來，有幾名陌生人來到市場詢問這名男子的住處與工作情況。從那之後，他便沒有再出現在店裡。請比較貨物交易紀錄與訂貨暗碼表，找出店員暗中記錄下來的姓氏。'
  ],
  questionHint: '先找出被標記的三筆訂單，再依每筆的品項與數量查表；不要從敘述猜名字。',
  options: [
