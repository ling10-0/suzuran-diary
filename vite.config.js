...
export default defineConfig({
  plugins: [routeTransform(), manuscriptTransform(), latestManuscriptsTransform(), syncTransform(), firstPuzzleTransform(), secondPuzzleTransform(), thirdPuzzleTransform(), fourthPuzzleTransform(), fifthPuzzleTransform(), sixthPuzzleTransform(), directoryTitleTransform(), finalSyncTransform(), readingGateTransform(), guidedMapLabelTransform(), react()],
  base: './'
});
